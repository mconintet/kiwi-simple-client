/**
 * Copyright https://github.com/mconintet/sop/blob/master/src/Template.js
 */
(function ($) {
    ...
    $(function () {
        $('script[type="text/jsTpl"]').each(function () {
            var n = this.dataset.name;
            if (!n) {
                throw new Error('there muse be a name of tpl');
            }

            Template._templates[n] = new Template(this.innerHTML, false).getCTpl();
            this.parentNode.removeChild(this);
        });
    });

    Template.get = function (tplName) {
        return Template._templates[tplName];
    };
